      ...
      <div className="glass-panel p-5 rounded-2xl space-y-4 animate-fade-up">
        <div className="flex justify-between items-start">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-1 rounded-lg text-[0.65rem] font-semibold bg-slate-900 text-slate-50 dark:bg-slate-50 dark:text-slate-905 hover:opacity-90 transition-opacity cursor-pointer"
          >
            <FiCode size={12} />
