...
export default function OllamaDiagnosticModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-sm animate-fade-in" onClick={onClose}>
      <div 
        className="w-full max-w-2xl bg-[var(--bg-surface)] rounded-2xl overflow-hidden shadow-2xl border border-slate-200/20 dark:border-slate-800/20 max-h-[90vh] flex flex-col"
